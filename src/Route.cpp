...
Route::Route() : _id(""), _route(""), _root(""), _page(""), _methods(), _listing(false), _isDownload(false), _downloadDir(""), _isRedir(false), _redirDir("")
{
}

Route::Route(std::string id) : _id(id), _route(""), _root(""), _page(""), _methods(), _listing(false), _isDownload(false), _downloadDir(""), _isRedir(false), _redirDir("")
{
}
